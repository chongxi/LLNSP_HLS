...
// ------------------------------------------------
  ...
  streampos npts = 320;
    ...
    ifstream file("Z:\\Work\\xike_hls_module\\spkDect\\spkDect_test.bin", ios::binary);
...
// ------------------------------------------------
    ofstream fout("Z:\\Work\\xike_hls_module\\spkDect\\spkDect_test_compare.bin", ios::binary);
